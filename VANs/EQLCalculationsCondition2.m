...
- (void)drawRect:(CGRect)rect {
    ...
    NSString *weightHorses = [NSString stringWithFormat:@"%iKg.", [sharedForm pesoCaballo]*[sharedForm numHorses]];
    NSString *weightTrailerAndHorses = [NSString stringWithFormat:@"%iKg.",(([sharedForm pesoCaballo]*[sharedForm numHorses])+[sharedForm trailerWeight])];
