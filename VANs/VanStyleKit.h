...
//  VAN Selector
//
//  Created by Marc Humet on 4/3/16.
//  Copyright (c) 2016 EQUUS LIFE SL. All rights reserved.
//
...
@property(strong, nonatomic) IBOutletCollection(NSObject) NSArray* placeHolderEmptyTableViewTargets;
...
+ (void)drawMaxCarTowWithFrame: (CGRect)frame;
+ (void)drawMagnifyingglass;
+ (void)drawScales;
+ (void)drawMaxHorseWeightWithFrame: (CGRect)frame;
...
+ (UIImage*)imageOfPlaceHolderEmptyTableView;
